...
class Parser:
  ...
  def parse(self):
    ...
    if l[0] in ("add", "sub", "neg", "eq", "gt", "lt", "and", "or", "not"):
      ...
      arg1 = l[1]
      arg2 = int(l[2])
    elif l[0] in ("goto", "if-goto", "label"):
      cmd_type = {"goto": self.C_GOTO, "if-goto": self.C_IF, "label": self.C_LABEL}.get(l[0])
      arg1 = l[1]
    else:
...
class CodeWriter:
  ...
  def writeCall(self, func, n_args):
    pass

  def writeReturn(self):
    pass

  def writeFunction(self, func, n_locals):
    pass
...
def translate(in_fn, out_fn):
  ...
  while p.hasMoreCommands():
    ...
    elif cmd == Parser.C_LABEL:
      cw.writeLabel(arg1)
    elif cmd == Parser.C_IF:
      cw.writeIf(arg1)
    elif cmd == Parser.C_GOTO:
      cw.writeGoto(arg1)
    else:
